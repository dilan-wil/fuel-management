...
export default function EligibilityCheckPage() {
  const consumedPercentage =
    (fuelLimitData.consumed / fuelLimitData.monthlyLimit) * 100;
  const dailyUsedPercentage =
    (fuelLimitData.dailyUsed / fuelLimitData.dailyLimit) * 100;
  const weeklyUsedPercentage =
    (fuelLimitData.weeklyUsed / fuelLimitData.weeklyLimit) * 100;

  const mileageSinceLastRefill = vehicleData.mileage - vehicleData.lastMileage;
  const isMileageEligible =
    mileageSinceLastRefill >= vehicleData.minimumMileageBetweenRefills;
    ...
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Check your eligibility for fuel requests based on mileage and
          consumption limits
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-md p-4">
        ...
        <p className="text-blue-700 mt-1">
          Your eligibility for fuel is determined by two main factors:
        </p>
        <ul className="text-blue-700 mt-2 space-y-1 list-disc pl-5">
          <li>
            You must have driven at least{" "}
            {vehicleData.minimumMileageBetweenRefills} km since your last refill
          </li>
          <li>
            You must have sufficient remaining allocation in your daily, weekly,
            and monthly limits
          </li>
        </ul>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="md:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Check if you've driven enough distance since your last refill
            </CardDescription>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-medium">
                        {vehicleData.lastMileage} km
                      </span>
                    </div>
                    <div className="flex justify-between text-sm mb-1">
                      <span>Distance Since Last Refill</span>
                      <span className="font-medium">
                        {mileageSinceLastRefill} km
                      </span>
                    </div>
                    <div className="flex justify-between text-sm mb-1">
                      <span>Minimum Required</span>
                      <span className="font-medium">
                        {vehicleData.minimumMileageBetweenRefills} km
                      </span>
                    </div>
                  </div>

                  <Alert
                    variant={isMileageEligible ? "default" : "destructive"}
                  >
                    {isMileageEligible ? (
                    ...
                    <AlertTitle>
                      {isMileageEligible
                        ? "Eligible Based on Mileage"
                        : "Not Eligible Based on Mileage"}
                    </AlertTitle>
                    <AlertDescription>
                      {isMileageEligible
                        ...
                        : `You've only driven ${mileageSinceLastRefill} km since your last refill. You need to drive at least ${
                            vehicleData.minimumMileageBetweenRefills -
                            mileageSinceLastRefill
                          } km more to be eligible.`}
                    </AlertDescription>
                  </Alert>
                </div>
              </div>
              ...
              <div>
                <h3 className="text-sm font-medium mb-2">
                  Check with New Odometer
                </h3>
                <div className="space-y-3">
                  <div className="space-y-2">
                    <Label htmlFor="new-odometer">
                      Enter New Odometer Reading (km)
                    </Label>
                    <Input
                      id="new-odometer"
                      type="number"
                  ...
                  <tbody className="divide-y divide-border">
                    {mileageHistory.map((entry, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-2 text-sm">
                          {((entry.refill / entry.distance) * 100).toFixed(1)}{" "}
                          L/100km
                        </td>
                      </tr>
                    ))}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your current fuel allocation status
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Remaining: {fuelLimitData.remaining}L
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Remaining:{" "}
                {fuelLimitData.weeklyLimit - fuelLimitData.weeklyUsed}L
              </p>
            </div>
            ...
            <div className="pt-2">
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-sm">
                  ...
                  <span>
                    {vehicleData.currentFuelLevel}L / {vehicleData.fuelCapacity}
                    L
                  </span>
                </div>
                <Progress
                  value={
                    (vehicleData.currentFuelLevel / vehicleData.fuelCapacity) *
                    100
                  }
                  className="h-2"
                />
                <p className="text-xs text-muted-foreground mt-1">
                  Available space: {spaceInTank}L
                </p>
              </div>
            </div>
            ...
            <div className="pt-2">
              ...
              <Alert>
                ...
                <AlertDescription>
                  Based on your limits and vehicle capacity, you can request up
                  to <strong>{maxRequestAmount} liters</strong> of fuel.
                </AlertDescription>
              </Alert>
            </div>
        ...
        <TabsContent value="efficiency" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track your vehicle's fuel efficiency over time
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-muted/50 p-3 rounded-md">
                  ...
                  <p className="text-xl font-bold">
                    {vehicleData.averageFuelEfficiency} L/100km
                  </p>
                  <p className="text-xs text-muted-foreground mt-1">
                    Based on your last 5 refills
                  </p>
                </div>
        ...
        <TabsContent value="recommendations" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Tips to improve your fuel efficiency and maximize your
                allocation
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4 py-2">
                  ...
                  <ul className="mt-2 space-y-1 text-sm">
                    ...
                    <li>
                      • Avoid excessive idling (turn off engine if stopped for
                      more than 1 minute)
                    </li>
                    <li>
                      • Plan your routes to avoid traffic congestion and
                      minimize distance
                    </li>
                  </ul>
                </div>
                ...
                <div className="border-l-4 border-amber-500 pl-4 py-2">
                  ...
                  <ul className="mt-2 space-y-1 text-sm">
                    <li>
                      • Remove unnecessary items from the vehicle to reduce
                      weight
                    </li>
                    <li>• Avoid carrying heavy loads when not necessary</li>
                    <li>
                      • Use roof racks only when needed (they increase drag)
                    </li>
                  </ul>
                </div>
                ...
                <Alert className="bg-blue-50 border-blue-100">
                  ...
                  <AlertDescription className="text-blue-700">
                    Based on your driving patterns, you could improve your
                    efficiency by approximately 0.3 L/100km by maintaining a
                    more consistent speed on your regular routes. This could
                    save up to 15 liters of fuel per month.
                  </AlertDescription>
                </Alert>
              </div>
            </CardContent>
